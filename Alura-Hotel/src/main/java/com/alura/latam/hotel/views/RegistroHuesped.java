package com.alura.latam.hotel.views;
...
import com.alura.latam.hotel.controller.ClienteController;
import com.alura.latam.hotel.controller.NacionalidadController;
import com.alura.latam.hotel.controller.ReservasController;
...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Reserva nuevaReserva) {
		...
		txtNombre.setBounds(560, 166, 285, 33);
		...
		txtApellido.setBounds(560, 238, 285, 33);
		...
		txtFechaN.setBounds(560, 309, 285, 36);
		...
		lblTelefono.setBounds(562, 438, 253, 14);
		...
		lblNumeroReserva.setBounds(562, 511, 253, 14);
		...
		txtNreserva.setBounds(560, 535, 285, 33);
		...
		separator_1_2.setBounds(560, 203, 289, 2);
		separator_1_2.setForeground(new Color(12, 138, 199));
		separator_1_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2);

		JSeparator separator_1_2_1 = new JSeparator();
		separator_1_2_1.setBounds(560, 275, 289, 2);
		separator_1_2_1.setForeground(new Color(12, 138, 199));
		separator_1_2_1.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_1);

		JSeparator separator_1_2_2 = new JSeparator();
		separator_1_2_2.setBounds(560, 350, 289, 2);
		separator_1_2_2.setForeground(new Color(12, 138, 199));
		separator_1_2_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_2);

		JSeparator separator_1_2_3 = new JSeparator();
		separator_1_2_3.setBounds(560, 426, 289, 2);
		separator_1_2_3.setForeground(new Color(12, 138, 199));
		separator_1_2_3.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_3);

		JSeparator separator_1_2_4 = new JSeparator();
		separator_1_2_4.setBounds(560, 499, 289, 2);
		separator_1_2_4.setForeground(new Color(12, 138, 199));
		separator_1_2_4.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_4);

		JSeparator separator_1_2_5 = new JSeparator();
		separator_1_2_5.setBounds(560, 573, 289, 2);
		separator_1_2_5.setForeground(new Color(12, 138, 199));
		separator_1_2_5.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_5);

		JPanel btnguardar = new JPanel();
		btnguardar.setBounds(723, 589, 122, 35);
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				guardarHuesped(nuevaReserva);
			}
		});
		...
		labelGuardar.setBounds(1, 1, 122, 35);
		...
		lblDNI.setBounds(560, 80, 253, 14);
		contentPane.add(lblDNI);

		JSeparator separator_1_2_5_1 = new JSeparator();
		separator_1_2_5_1.setForeground(new Color(12, 138, 199));
		separator_1_2_5_1.setBackground(new Color(12, 138, 199));
		separator_1_2_5_1.setBounds(560, 133, 289, 2);
		contentPane.add(separator_1_2_5_1);

		txtDNI = new JTextField();
		txtDNI.setBorder(new EmptyBorder(0, 0, 0, 0));
		txtDNI.setBackground(Color.WHITE);
		txtDNI.setBounds(562, 98, 285, 33);
	...
	private void guardarHuesped(Reserva nuevaReserva) {
		...
		if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
			...
			Cliente cliente = new Cliente(txtDNI.getText()
					, txtNombre.getText()
					, txtApellido.getText()
					, fechaN
					, txtNacionalidad.getSelectedItem().toString()
					, txtTelefono.getText(), nuevaReserva.getRes_id());

			this.clienteController.guardar(cliente);

			nuevaReserva.setRes_cliente(cliente);
